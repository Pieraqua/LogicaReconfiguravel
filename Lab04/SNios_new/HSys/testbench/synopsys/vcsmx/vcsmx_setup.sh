...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/HSys_top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/top_avalon.vhd"                                                                          -work top_avalon_0                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/cont8.vhd"                                                                               -work top_avalon_0                                                                  
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/reg32.vhd"                                                                               -work top_avalon_0                                                                  
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/hsys_top_avalon_0_avalon_slave_0_translator.vhd"                                         -work HSys_inst                                                                     
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/HSys_tb/simulation/submodules/hsys_top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"          -work HSys_inst                                                                     
