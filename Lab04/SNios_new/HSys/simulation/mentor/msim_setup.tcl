...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/HSys_memory.hex ./
}
...
alias com {
  echo "\[exec\] com"
  vcom     "$QSYS_SIMDIR/submodules/HSys_irq_mapper.vho"                                                                     -work irq_mapper                                                                    
  ...
  vcom     "$QSYS_SIMDIR/submodules/HSys_rsp_xbar_mux.vho"                                                                   -work rsp_xbar_mux                                                                  
  vcom     "$QSYS_SIMDIR/submodules/HSys_cmd_xbar_mux.vho"                                                                   -work cmd_xbar_mux                                                                  
  vcom     "$QSYS_SIMDIR/submodules/HSys_cmd_xbar_demux.vho"                                                                 -work cmd_xbar_demux                                                                
  ...
  vcom     "$QSYS_SIMDIR/submodules/HSys_id_router_001.vho"                                                                  -work id_router_001                                                                 
  vcom     "$QSYS_SIMDIR/submodules/HSys_id_router.vho"                                                                      -work id_router                                                                     
  vcom     "$QSYS_SIMDIR/submodules/HSys_addr_router.vho"                                                                    -work addr_router                                                                   
  vcom     "$QSYS_SIMDIR/submodules/HSys_top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent_rsp_fifo
  vcom     "$QSYS_SIMDIR/submodules/HSys_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"                   -work memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo                  
  ...
  vcom     "$QSYS_SIMDIR/submodules/top_avalon.vhd"                                                                          -work top_avalon_0                                                                  
  vcom     "$QSYS_SIMDIR/submodules/cont8.vhd"                                                                               -work top_avalon_0                                                                  
  vcom     "$QSYS_SIMDIR/submodules/reg32.vhd"                                                                               -work top_avalon_0                                                                  
  vcom     "$QSYS_SIMDIR/submodules/HSys_cpu.vhd"                                                                            -work cpu                                                                           
  vcom     "$QSYS_SIMDIR/submodules/HSys_cpu_test_bench.vhd"                                                                 -work cpu                                                                           
  vcom     "$QSYS_SIMDIR/submodules/HSys_memory.vhd"                                                                         -work memory                                                                        
  vcom     "$QSYS_SIMDIR/HSys.vhd"                                                                                                                                                                               
  vcom     "$QSYS_SIMDIR/hsys_memory_s1_translator.vhd"                                                                                                                                                          
  vcom     "$QSYS_SIMDIR/hsys_top_avalon_0_avalon_slave_0_translator.vhd"                                                                                                                                        
  vcom     "$QSYS_SIMDIR/hsys_memory_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                                           
  vcom     "$QSYS_SIMDIR/hsys_top_avalon_0_avalon_slave_0_translator_avalon_universal_slave_0_agent.vhd"                                                                                                         
  vcom     "$QSYS_SIMDIR/hsys_width_adapter.vhd"                                                                                                                                                                 
  vcom     "$QSYS_SIMDIR/hsys_width_adapter_001.vhd"                                                                                                                                                             
  vcom     "$QSYS_SIMDIR/hsys_cpu_instruction_master_translator.vhd"                                                                                                                                             
  vcom     "$QSYS_SIMDIR/hsys_cpu_data_master_translator.vhd"                                                                                                                                                    
}
