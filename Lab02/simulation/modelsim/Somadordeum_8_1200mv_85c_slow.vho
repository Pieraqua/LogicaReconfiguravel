...
-- Equation(s):
-- \Mux2~0_combout\ = \INPUT[3]~input_o\ $ (\INPUT[0]~input_o\ $ (\INPUT[2]~input_o\ $ (\INPUT[1]~input_o\)))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\INPUT[3]~input_o\ & ((\INPUT[0]~input_o\ & ((!\INPUT[1]~input_o\) # (!\INPUT[2]~input_o\))) # (!\INPUT[0]~input_o\ & ((\INPUT[2]~input_o\) # (\INPUT[1]~input_o\))))) # (!\INPUT[3]~input_o\ & ((\INPUT[0]~input_o\ & 
-- ((\INPUT[2]~input_o\) # (\INPUT[1]~input_o\))) # (!\INPUT[0]~input_o\ & (\INPUT[2]~input_o\ & \INPUT[1]~input_o\))))
...
-- Equation(s):
-- \Mux0~0_combout\ = (\INPUT[3]~input_o\ & (\INPUT[0]~input_o\ & (\INPUT[2]~input_o\ & \INPUT[1]~input_o\)))
